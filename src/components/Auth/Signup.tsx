  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h2 className="text-2xl font-black tracking-tighter uppercase mb-2">Create Account</h2>
        <p className="text-zinc-400 text-sm">Join the local discovery community</p>
      </div>
